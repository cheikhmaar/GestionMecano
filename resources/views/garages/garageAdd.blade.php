            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-10 offset-1">
                        <div>
                            <a href="{{ route('garageList') }}" class="btn btn-primary">Voir liste</a>
                        </div>
                        </br>
                        <!-- general form elements -->
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Ajout Garage</h3>

                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->

                            <form method="POST" action="{{ route('garageStore') }}">
                                @csrf
                                <div class="card-body col-md-6 offset-1">
                                    ...
                                    <div class="form-group">
                                        <label for="">Nom Garage</label>
                                        <input type="text" class="form-control" name="nomGarage" required>
                                    </div>
