            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-10 offset-1">
                        <div>
                            <a href="{{ route('noterList') }}" class="btn btn-primary">Voir liste</a>
                        </div>
                        </br>
                        <!-- general form elements -->
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Ajout Note</h3>

                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->

                            <form method="POST" action="{{ route('noterStore') }}">
                                @csrf
                                <div class="card-body col-md-6 offset-1">
                                    <div class="form-group">
                                        <label for="">Noter</label>
                                        <select name="noter" class="form-control show-tick">
                                            <option value="0">-- Veuillez choisir une note --</option>
                                            <option> 1 </option>
                                            <option> 2 </option>
                                            <option> 3 </option>
                                            <option> 4 </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="professionnel_vehicule_id" class="form-control show-tick">
                                            <option value="0">-- Veuillez choisir un professionnel --</option>
